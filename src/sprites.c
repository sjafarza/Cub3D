...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/05 19:11:53 by saray             #+#    #+#             */
/*   Updated: 2021/04/23 09:11:52 by saray            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_calculs(t_recup *recup, int i)
{
	...
	recup->s.spritescreenx = (int)((recup->rx / 2) * (1 + \
				recup->s.transformx / recup->s.transformy));
...
void	ft_draw_spr(t_recup *recup, int y, int texx, int stripe)
{
	...
	while (y < recup->s.drawendy)
	{
		...
		if (recup->texture[4].addr[texy * recup->texture[4].line_length \
				/ 4 + texx] != -16777216)
		{
